...
@class ChivoxSRWebSocket; // TODO: (nlutsenko) Remove dependency on SRWebSocket here.
...
@interface ChivoxSRIOConsumer : NSObject {
...
typedef ChivoxSRIOConsumer SRIOConsumer;
